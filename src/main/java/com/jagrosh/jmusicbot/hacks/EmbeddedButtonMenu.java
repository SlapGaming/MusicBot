package com.jagrosh.jmusicbot.hacks;
...
public class EmbeddedButtonMenu extends Menu {
    ...
    EmbeddedButtonMenu(EventWaiter waiter, Set<User> users, Set<Role> roles, long timeout, TimeUnit unit,
                       MessageEmbed messageEmbed, List<String> choices, Consumer<ReactionEmote> action, Consumer<Message> finalAction)
    {
    ...
    public static class Builder extends Menu.Builder<Builder, EmbeddedButtonMenu>
    {
         ...
         *
         * @param  finalAction
         *         The Runnable action to perform if the EmbeddedButtonMenu is done
         *
         * @return This builder
         */
